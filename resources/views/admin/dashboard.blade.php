...
<div class="max-w-7xl w-full mx-auto space-y-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('admin.portfolios.index') }}" class="group bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 p-8 rounded-2xl shadow-sm hover:border-black dark:hover:border-white transition duration-300 flex flex-col justify-between">
            <div>
                <div class="text-xs uppercase tracking-widest font-bold opacity-40">Management</div>
                <div class="font-display text-3xl font-black tracking-tight mt-4">Portofolio</div>
            </div>
        ...
        <a href="{{ route('admin.plugins.index') }}" class="group bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 p-8 rounded-2xl shadow-sm hover:border-black dark:hover:border-white transition duration-300 flex flex-col justify-between">
            <div>
                <div class="text-xs uppercase tracking-widest font-bold opacity-40">Management</div>
                <div class="font-display text-3xl font-black tracking-tight mt-4">Plugins</div>
            </div>
            <span class="text-xs font-medium text-zinc-500 mt-6 group-hover:text-black dark:group-hover:text-white transition">Kelola halaman plugins user →</span>
        </a>
    </div>
</div>
@endsection